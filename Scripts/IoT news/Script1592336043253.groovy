...
News = WebUI.getText(findTestObject('Notice'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Notice'))

WebUI.verifyElementText(findTestObject('entry-title single-title'), News)
...
WebUI.verifyElementText(findTestObject('article-header'), News)
